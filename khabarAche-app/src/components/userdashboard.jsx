        ...
        <div className="sidebar-main">
          ...
          <div className="sidebar-menu">
            ...
            <ul>
              ...
              <li><a href="#"><span className="bx bx-shopping-bag"></span> Favourite Hotels</a></li>
        ...
        <main>
          <div className="page-header">
            ...
            <div className="header-actions">
              <button><span className="bx bx-file-export"></span> Report</button>
          ...
          <div className="cards">
            {[
              ...
              { title: "Purchases", count: 5, desc: "Till now you have purchased from 5 hotels to donate" },
              { title: "Free-Purchases", count: 12, desc: "Till now you have purchased free from 12 hotels to donate" }
            ].map((card, index) => (
          ...
          <div className="jobs-grid">
            <div className="analytics-card">
              ...
              <div className="analytics-chart">
                ...
                <div className="analytics-note">
                  <small>You can download PDFs containing details of your donations.</small>
                </div>
              </div>
            ...
            <div className="jobs">
              <h2>Donate <small>See all donation opportunities<span className="bx bx-right-arrow-alt"></span></small></h2>
              <div className="table-responsive">
                <table width="100%">
                  <tbody>
                    {["Kacchi Vai", "The Restaurant", "Bangla Ghor", "Hazir Biriyani"].map((name, index) => (
                      <tr key={index}>
                        <td><div><span className={`indicator ${index % 2 === 0 ? "" : "even"}`}></span></div></td>
                        <td><div>{name}</div></td>
                        <td><div>Menu</div></td>
                        <td><div>Description</div></td>
                        <td><div><button>{index % 2 === 0 ? "Applied" : "Apply"}</button></div></td>
                      </tr>
                    ))}
                  </tbody>
                </table>
